...
Version  : 4.3.4
Release  : 29
URL      : https://files.pythonhosted.org/packages/dc/ea/8425c65b87e5ba5ffd18b69abfae31094621ae54af0bc07afa3555f7ad54/zope.proxy-4.3.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/dc/ea/8425c65b87e5ba5ffd18b69abfae31094621ae54af0bc07afa3555f7ad54/zope.proxy-4.3.4.tar.gz
...
%prep
%setup -q -n zope.proxy-4.3.4
cd %{_builddir}/zope.proxy-4.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584310367
...
cp %{_builddir}/zope.proxy-4.3.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.proxy/a0b53f43aab58b46bf79ba756c50771c605ab4c5
