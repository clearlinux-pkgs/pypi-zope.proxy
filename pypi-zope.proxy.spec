...
Source0  : https://files.pythonhosted.org/packages/1f/cc/42cf13980331e234048307e171c55fc72ddebfc4d41b55e224f12e257f5c/zope.proxy-5.2.tar.gz
...
%prep
%setup -q -n zope.proxy-5.2
cd %{_builddir}/zope.proxy-5.2
pushd ..
cp -a zope.proxy-5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707500278
